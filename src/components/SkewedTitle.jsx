...
export default function SkewedTitle({ children }) {
    return (
      <div className="relative inline-block mx-auto skewed-title">
        ...
        {/* Título principal */}
        <h2 className="relative z-10 px-6 py-3 text-3xl text-shadow-md font-bold text-[var(--primary-color)] bg-[var(--rosado-color)] border-r-4 border-b-4 border-[var(--rose-color)] skew-x-[-6deg] rounded text-center">
  {children}
</h2>
      </div>
    );
